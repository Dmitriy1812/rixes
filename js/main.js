...
/* harmony import */ var _components_catalog_market_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/catalog-market.js */ "./src/js/components/catalog-market.js");
/* harmony import */ var _components_catalog_market_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_catalog_market_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_advantages_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/advantages.js */ "./src/js/components/advantages.js");
/* harmony import */ var _components_advantages_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_advantages_js__WEBPACK_IMPORTED_MODULE_2__);
...
/***/ "./src/js/components/catalog-market.js":
/*!*********************************************!*\
  !*** ./src/js/components/catalog-market.js ***!
  \*********************************************/
/***/ (() => {
...
if (catalogBabyOrder) {
  ...
  function printLog(isMobileSize) {
    if (isMobileSize) {
      ...
      catalogBabyOrder.textContent = 'Открыть каталог:';
    }
...
let img = document.querySelector('.materials__base-img');
let insertNodeP = document.querySelector('.materials-top-wrap p');
let insertNodeH2 = document.querySelector('.materials__base-title');
if (materials) {
  // console.log(catalogBabyOrder)
  ...
  function printLog(isMobileSize) {
    // debugger
    if (isMobileSize) {
      insertNodeP.after(img);
    } else {
      insertNodeH2.after(img);
      // catalogBabyOrder.textContent = 'Открыть каталог:'
    }
    // const size = isMobileSize ? 'уже или равен' : 'шире'
...
// console.log(Swiper)
let el = document.querySelector('.hero__swiper');
...
let catalogSleep = document.querySelector('.js-catalog-sleep');
const swiperCatalogSleep = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](catalogSleep, {
  slidesPerView: 'auto',
  navigation: {
    nextEl: '.catalog__container--sleep .swiper-button-next',
    prevEl: '.catalog__container--sleep .swiper-button-prev'
  },
  // pagination: {
  //   el: '.hero .swiper-pagination',
  //   type: 'bullets',
...
let catalogBaby = document.querySelector('.js-catalog-baby');
const swiperCatalogBaby = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](catalogBaby, {
  slidesPerView: 'auto',
  navigation: {
    nextEl: '.catalog__container--baby .swiper-button-next',
    prevEl: '.catalog__container--baby .swiper-button-prev'
  },
  // pagination: {
  //   el: '.hero .swiper-pagination',
  //   type: 'bullets',
...
const swiperProduct = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector('.product-carousel .swiper'), {
  slidesPerView: 'auto',
  navigation: {
...
// var swiperCategory = new Swiper(".product-carousel .mySwiper", {
//   loop: true,
//   spaceBetween: 10,
//   slidesPerView: 4,
//   freeMode: true,
...
(function () {
  ...
  const burgerClose = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelector('.header__burger--close');
  ...
  burgerClose === null || burgerClose === void 0 ? void 0 : burgerClose.addEventListener('click', () => {
    burger === null || burger === void 0 ? void 0 : burger.setAttribute('aria-expanded', 'false');
    burger === null || burger === void 0 ? void 0 : burger.setAttribute('aria-label', 'Открыть меню');
    burger.classList.remove('burger--active');
    menu.classList.remove('menu--active');
